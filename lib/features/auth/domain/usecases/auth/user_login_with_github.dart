...
@injectable
class UserLoginWithGithub implements UseCase<UserDetailsEntity, NoParams> {
  const UserLoginWithGithub(this.authRepository);
  final AuthRepository authRepository;

  @override
  Future<Either<Failure, UserDetailsEntity>> call(NoParams params) async {
    return authRepository.loginWithGithub();
  }
}
